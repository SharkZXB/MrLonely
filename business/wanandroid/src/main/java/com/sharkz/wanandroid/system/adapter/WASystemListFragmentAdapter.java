 ...
 * ================================================
 */
public class WASystemListFragmentAdapter extends BaseQuickAdapter<WASystemListAPIBean.DataBean.DatasBean, BaseViewHolder> {

    public WASystemListFragmentAdapter(@Nullable List<WASystemListAPIBean.DataBean.DatasBean> data) {
        super(R.layout.wa_item_system_list_fragment_adapter, data);
    }

    @Override
    protected void convert(@NonNull BaseViewHolder helper, final WASystemListAPIBean.DataBean.DatasBean item) {
